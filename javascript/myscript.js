...
theTime.add({
	...
	update: function(percent) {
		...
		document.querySelector('.container .sup').innerHTML= "Click vào đây trước nhé " + (thePercent+899);
	}
});
theTime.add({
	targets: getHeart,
...
document.querySelector('.Description .modal-title').innerHTML = '<i class="far fa-comment-alt"></i>&nbsp;Hello Em Gái:';
document.querySelector('.Description .modal-body').innerHTML = 'Chúc mừng sinh nhật em gái nha !<i class="fas fa-heart"></i> ';
